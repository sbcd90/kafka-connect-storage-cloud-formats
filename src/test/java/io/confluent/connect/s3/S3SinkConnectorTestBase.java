...
public class S3SinkConnectorTestBase extends StorageSinkTestBase {
    ...
    protected Map<String, String> createProps() {
        ...
        props.put(S3SinkConnectorConfig.FORMAT_CLASS_CONFIG, AvroData.class.getName());
    ...
    public void setUp() throws Exception {
        ...
        compatibility = StorageSchemaCompatibility.getCompatibility("schema.compatibility");
    }
